...
namespace Arctic
{
		...
		m_Swapchain(g_GameVariables->m_Swapchain)
	{
		...
		style.FrameRounding = 5.0f;                        // Radius of frame corners rounding. Set to 0.0f to have rectangular frames (used by most widgets).
		...
		style.GrabRounding = 5.0f;                         // Radius of grabs corners rounding. Set to 0.0f to have rectangular slider grabs.
