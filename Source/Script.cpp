...
namespace Saint
{
	...
	void MainScript::Initialize()
	{
		...
		sub->draw_option<submenu>("DLC Enabler", nullptr, SubmenuDLC);
		...
		*script_global(262145 + 31383).as<int64_t*>() = 1; // 2021_new_years_gift
		...
		g_Render->draw_submenu<sub>("Unlocks", SubmenuUnlocks, [](sub* sub)
			{
				...
				sub->draw_option<RegularOption>("Unlock All", "", [] {
		...
		sub->draw_option<RegularOption>("Unlock Speical T-Shirts", "", [] {
		...
		*script_global(262145 + 20926).as<int64_t*>() = 1; // "WHITE_VOM_FEUER_HOODIE
		...
		sub->draw_option<RegularOption>("Unlock Special Hats", "", [] {
		...
		*script_global(262145 + 12389).as<int64_t*>() = 1; // "Davis Hat"
		...
		sub->draw_option<RegularOption>("Unlock Misc Outfits", "", [] {
